...
# Stord
set -x OBAN_KEY_FINGERPRINT SHA256:4/OSKi0NRF91QVVXlGAhb/BIMLnK8NHcx/EWs+aIWPc
set -x OBAN_LICENSE_KEY xjhd4hhgkdv2zsu3vv3x53lcwumtvhar
set -x EDITOR hx
...
if status is-interactive
    ...
    # if [ -d ~/git/stordco ]
    #     echo "Stord directory found. Importing stord-aliases.fish"
    #     source ~/git/dots/scripts/stord-aliases.fish
    # end
